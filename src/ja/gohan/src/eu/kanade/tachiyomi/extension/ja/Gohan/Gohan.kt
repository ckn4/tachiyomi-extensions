package eu.kanade.tachiyomi.extension.ja.gohan
...
class gohan : ParsedHttpSource() {
    override val name = "MangaGohans"
    override val baseUrl = "https://gokumanga.com/"
    ...
    override fun popularMangaFromElement(element: Element): SManga {
        ...
        with(element) {
            select(popularMangaUrlSelector).first()?.let {
                ...
                manga.title = it.ownText().substringBefore("(Raw – Free)").trim()
            }
